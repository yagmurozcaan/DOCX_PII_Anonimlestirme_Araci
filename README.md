...
```bash
python main.py --input inputs/case_09_01_2026.docx --output results/case_09_01_2026_anonymized.docx --mapping results/case_09_01_2026_mapping.csv --config config.json
```
